...
interface TimecodeWithObjects extends Timecode {
  objects: string[];
}

interface TimecodeWithValue {
  time: string;
  value: number;
}
...
interface Function extends FunctionDefinition {
...
export default function(fnMap: FunctionMap): Function[] {
